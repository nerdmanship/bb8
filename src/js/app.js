var project = function() {
  ...
  function createTimeline() {
    ...
    tl
    .to(bb8.bb8, 1, { y: "+=250", ease: Power1.easeInOut, repeat: -1, yoyo:true }, 0)
    .to(bb8.bb8, 1, { scale: 1.2, transformOrigin: "center bottom", ease: Power1.easeInOut, repeat: -1, yoyo:true }, 0)
    .to(bb8.bb8, 2, { x: "-=150", ease: Power1.easeInOut, repeat: -1, yoyo:true }, 0)
    .to(bb8.unit, 0.05, { y: "-=10", ease: Power1.easeInOut, repeat: -1, yoyo:true }, 0)
    .to(bb8.bouncingHead, 0.05, { y: "-=10", ease: Power1.easeInOut, repeat: -1, yoyo:true }, 0.02)
    ...
    .to(bb8.bodySurface, 1, { y: "+=200", ease: Power1.easeInOut, repeat: -1, yoyo: true }, 0)
    .to(bb8.bodySurface, 2, { x: "+=100", ease: Power1.easeInOut, repeat: -1, yoyo: true }, 0)
    ...
    .to(gravel, 0.75, { x: "+=4000", ease: Linear.easeNone, repeat: -1 }, 0);
  }
  function roll() {
    if(rollingRight) {
