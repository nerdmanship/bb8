    ...
    var bb8Module = {
        ...
        defineTimelines: function() {
            ...
            this.tl.intro
                ...
                .add("startRolling")
                .add(bb8Module.spinHead, "startRolling")
                .set(this.bb8.bb8, { y: 400, scale: 1, transformOrigin: "center bottom" }, "startRolling")
                ...
                .to(this.bb8.bb8, 1, { y: "+=300", scale: 1.18, transformOrigin: "center bottom", ease: Power1.easeInOut, repeat: 1000, yoyo:true }, "startRolling")
                .to(this.bb8.bodySurface, 1, { y: "+=200", ease: Power1.easeInOut, repeat: 1000, yoyo: true }, "startRolling")
                .to(this.bb8.bodySurface, 2, { x: "+=100", ease: Power1.easeInOut, repeat: 500, yoyo: true }, "startRolling")
                // Rolling
                .to(this.bb8.bodySurface, 1, { rotation: "-=360", ease: Linear.easeNone, repeat: 100 }, "startRolling")
                // Bouncing
                .to(this.bb8.unit, 0.05, { y: "-=10", ease: Power1.easeInOut, repeat: 20000, yoyo:true }, "startRolling")
                .to(this.bb8.bouncingHead, 0.05, { y: "-=10", ease: Power1.easeInOut, repeat: 20000, yoyo:true }, "startRolling")
                // Rotating head
                // ...
                // Spinning head
            ...
            // ROLLING
            this.tl.left
                .to(this.bb8.bodySurface, 0.5, { rotation: "-=360", transformOrigin: "center", ease: Linear.easeNone, repeat: 500 });
